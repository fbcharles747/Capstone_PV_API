...
class FixMount(BaseModel):
    surface_tilt: Annotated[float, Body(description="Surface tilt angle in degrees")] = 47
...
class SolarArray(BaseModel):
    ...
    strings: Annotated[int, Body(description="Number of strings")] = 400
...
class PVSystemModel(BaseModel):
    name: Annotated[str, Body(description="Name of the PV system")] = "ATCO Barlow Site"
